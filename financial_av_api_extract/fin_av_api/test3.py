...
def upload_file_to_s3(file, file_name):
    result = s3_client.upload_file(file, S3_BUCKET, file_name)
    return result
...
pop_stocks_list = ["TSLA", "AAPL", "AMZN",  "MSFT"]
# pop_stocks_list = ["TSLA", "AAPL", "AMZN",  "MSFT", "NIO", "NVDA", "MRNA", "NKLA"]
all_stk_tek_ind_list = []
tek_ind = "RSI"
tek_ind_file_nm = "relative_strength_index.csv"
    #######################################
